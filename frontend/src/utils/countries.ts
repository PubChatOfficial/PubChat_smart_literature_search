...
// /**
//  * Get flag emoji from country code (fallback for non-Windows)
//  */
...
// /**
//  * Get flag-icons CSS class from country code
//  * Returns class name like "fi fi-cn" for use with flag-icons library
//  */
